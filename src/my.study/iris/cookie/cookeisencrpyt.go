...
func newAppEn() *iris.Application {
	app := iris.New()
	...
	return app
	/*
	http://localhost:8080/cookies/my_cookie_name/my_cookie_value
	cookie added: my_cookie_name = my_cookie_value
	 */
}

func CookieEncryptmain() {
	app := newAppEn()
