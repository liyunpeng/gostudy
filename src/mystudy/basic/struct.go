...
func struct1() {
	...
	/*
		...
		goroutine 1 [running]:
		gostudy/src/mystudy/basic.struct1()
		        F:/GoWorkSpace/gostudy/src/mystudy/basic/struct.go:90 +0x2b0
		gostudy/src/mystudy/basic.Struct()
		        F:/GoWorkSpace/gostudy/src/mystudy/basic/struct.go:165 +0x8a
		main.base()
